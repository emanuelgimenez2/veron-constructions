        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 sm:static">
          <div className="sm:max-w-lg">
            ...
            <p className="mt-4 text-xl text-gray-500">
              Visita la lista de nuestros trabajos y proyectos realizados por nuestros expertos
            </p>
          </div>
          <div>
            <div className="mt-10">
                  ...
                  <div className="flex items-center space-x-6 lg:space-x-8">
                    <div className="flex-shrink-0 grid grid-cols-1 gap-y-6 lg:gap-y-8">
                      <div className="w-44 h-64 rounded-lg overflow-hidden sm:opacity-0 lg:opacity-100">
                        <img
                          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTlfuaaUGM-KPQkP13DOTlbq5yaRPpH3UEciCTrjmnrszyYLUq2TSCcjv0NjRhfQTdDz8o&usqp=CAU"
                          alt=""
                      ...
                      <div className="w-44 h-64 rounded-lg overflow-hidden">
                        <img
                          src="https://www.msmaderas.com.ar/images/durlock-2.jpg"
                          alt=""
                          className="w-full h-full object-center object-cover"
                        />
                      </div>
                    ...
                    <div className="flex-shrink-0 grid grid-cols-1 gap-y-6 lg:gap-y-8">
                      <div className="w-44 h-64 rounded-lg overflow-hidden">
                        <img
                          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS9MK80o2CDMmxMNhKrpcdUcf6JdIM-SnkVWQPTvcpQaYDZjtNuYeV-I59NSXYYEKODccY&usqp=CAU"
                          alt=""
                          className="w-full h-full object-center object-cover"
                        />
                      </div>
